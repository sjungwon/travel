...
public class ItemSQLs {
    ...
    public final String FIND_BY_ID = "SELECT {I.id, I.title,  I.address_detail, I.thumbnail, I.description, I.created_at, I.updated_at, A.zonecode, A.address, C.en as category_en, M.store_file_name} " +
            "FROM ITEM I " +
    ...
    public final String FIND_ALL = "SELECT {I.id, I.title,  I.address_detail, I.thumbnail, I.description, I.created_at, I.updated_at, A.zonecode, A.address, C.en as category_en, M.store_file_name} " +
            "FROM ITEM I " +
